...
def retrieval_eval(model, ref_model, t_model, t_ref_model, t_test_transform, data_loader, tokenizer, t_tokenizer, device, config):
    ...
    # img_attacker = ImageAttacker(images_normalize, eps=16.0/255, steps=10, step_size=4/255) # default: eps=2/255, steps=10, step_size=0.5/255 (按照4:1设置步长) 
