...
def eval_asr(model, ref_model, tokenizer, t_model, t_ref_model, t_tokenizer, t_test_transform, data_loader, device, args, config):
    ...
    result = itm_eval(score_i2t, score_t2i, data_loader.dataset.img2txt, data_loader.dataset.txt2img, 'CLIP_CNN')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--target_ckpt', default='./checkpoints/albef_retrieval_flickr.pth', type=str)    
